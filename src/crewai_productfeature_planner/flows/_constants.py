...
class PRDState(BaseModel):
    ...
    figma_design_url: str = Field(
        default="",
        description="URL of the Figma file generated by the UX Designer via Figma Make.",
    )
    figma_design_prompt: str = Field(
        default="",
        description="Figma Make prompt generated by the UX Designer (stored when Figma credentials unavailable).",
    )
    figma_design_status: str = Field(
        default="",
        description=(
            "UX design generation status: '' (not started), "
            "'generating' (agent working), 'prompting' (sent to Figma Make), "
            "'completed' (URL available), 'prompt_ready' (prompt only, no Figma creds), "
