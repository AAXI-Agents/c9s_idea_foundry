"""Idea input, refinement, approval gates, and post-run prompts for the CLI.

Contains the interactive prompts for getting an idea, choosing a
refinement mode, manual idea refinement loop, and approval gates for
refined ideas and requirements breakdowns.
"""
